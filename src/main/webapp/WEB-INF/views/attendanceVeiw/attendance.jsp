...
<div class="wrapper">
  <div class="content-wrapper">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-4">
                <div class="card stat-card p-3 text-center">
                  ...
                  <h4 class="fw-bold"><c:out value ="${monthlyWorkingHours}"/>/ 98</h4>
    ...
    <tbody>
        <c:forEach var="att" items="${todaysAttendance}">
            <tr>
                <td><c:out value="${att.date}"/></td>
                <td><c:out value="${att.check_in}"/></td>
                <td><c:out value="${att.lunch_out}"/></td>
                <td><c:out value="${att.lunch_in}"/></td>
                <td><c:out value="${att.check_out}"/></td>
                <td><c:out value="${att.working_hours}"/></td>
                <td><c:out value="${att.break_hour}"/></td>
            </tr>
        </c:forEach>
    </tbody>
              </table>
