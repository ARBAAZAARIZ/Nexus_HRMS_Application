...
public class ManagerDao {
    ...
    public List<TimeSheet> getPendingTimeSheets() throws SQLException {
        ...
        String sql = "SELECT ts.*, u.first_name, u.last_name " +
                     "FROM time_sheet ts " +
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            System.err.println("Database error in getPendingTimeSheets(): " + e.getMessage());
            e.printStackTrace();
            throw e; 
        }
...
=======
    ...
    public void updateStatusBulk(List<Integer> ids, String status) throws SQLException {
        if (ids == null || ids.isEmpty()) return;

        String query = "UPDATE time_sheet SET status=? WHERE time_sheet_id=?";
        System.out.println(status + "from dao ");
        try (Connection conn = DatabaseConnection.getConnection();
